...
export function MotivationSection() {
  ...
  // The video is skipped entirely on a metered or reduced-motion visit, and a
  // mute button over an empty box is a control for nothing.
      ...
      <div className="container-main [--container-px:0.5rem] sm:[--container-px:0.75rem] lg:[--container-px:clamp(1rem,5vw,2rem)] relative z-10">
        ...
        >
          <div className="relative w-full max-w-[384px] h-[500px] lg:h-[682px] rounded-[32px] lg:rounded-[40px] overflow-hidden bg-neutral-900">
            {/* Video — requested only as the section comes into range, and
                paused again once it has gone. */}
            <LazyVideo
              src={VIDEO_URL}
              muted={isMuted}
              onActiveChange={setHasVideo}
